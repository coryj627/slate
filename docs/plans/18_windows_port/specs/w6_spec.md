...
Program: [00_program.md](../00_program.md) (decision 14; DoD §W-A/§W-C/§W-D). Behavioral reference: the T program (`../../09_canvas/00_program.md`, interaction contract `t0_interaction_contract.md`, AT checklist) and the P program (`../../11_graph/00_program.md`).
...
4. Authoring parity: full T verb set (create/delete/color/group/connect/edit/duplicate/convert/locate…), card editor, pickers, color accessibility set (APCA-verified fills, Increase Contrast collapse, nearest-preset naming) via shared tokens (W8-2).
