...
2. All mutations route through existing core session APIs (rename/move produce the same link rewrites as mac — §W-A covers this).
...
1. Ctrl+T (chord table, decision 12) fuzzy file open over the **W0.5-2 core ranking** — zero C# scoring.
