...
**Status:** 📝 Specs locked (2026-07-03); implementation not started. Sequenced **after** the UI Parity program's U1 shell (landed) per the 2026-07-03 owner decision; see [sequencing gates](#sequencing-gates). GH milestone 20; issues #359–#373 (original) + #517–#526 (added by the 2026-07 interview + gap review).
