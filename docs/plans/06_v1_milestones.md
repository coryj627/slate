...
| N — Bases v1 | [milestone 14](https://github.com/coryj627/slate/milestone/14) | Implements `05` §8. Biggest scope item in V1.x; recommended after K–M. **Program + executable specs: [`17_bases/`](17_bases/00_program.md)** (2026-07-06; refines the GH milestone description into issues [#690–#711](https://github.com/coryj627/slate/milestone/14) and supersedes it where they differ). Research base: [`17_bases/01_research_brief.md`](17_bases/01_research_brief.md). |
