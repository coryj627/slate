...
///
/// Lives at `~/Library/Application Support/YANA/recent-vaults.json`
...
public final class RecentVaultsStore {
    ...
    /// Standard location:
    /// `~/Library/Application Support/YANA/recent-vaults.json`.
    ...
    private static func defaultDirectory() throws -> URL {
        ...
        return appSupport.appendingPathComponent("YANA", isDirectory: true)
    }
}
