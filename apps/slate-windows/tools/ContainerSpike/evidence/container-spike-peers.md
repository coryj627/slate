...
| measurement | flow/detached | flow/windowed | flowpeers/detached | flowpeers/windowed | items/detached | items/windowed |
|---|---|---|---|---|---|---|
| surface control type | Document | Document | Document | Document | Pane | Pane |
| peers in tree | 16 | 16 | 36 | 36 | 38 | 38 |
| Text provider present | **yes** | **yes** | **yes** | **yes** | **no** | **no** |
| Text provider host | Document | Document | Document | Document | — | — |
| reading-order chars | 363 | 363 | 363 | 363 | 0 | 0 |
| landmarks found | 12/14 | 12/14 | 12/14 | 12/14 | 0/14 | 0/14 |
| landmarks missing | fn main, Embedded note | fn main, Embedded note | fn main, Embedded note | fn main, Embedded note | Reading container spike, resolved note, absent note, Second level heading, first bullet, nested bullet, ordered one, an open task, a done task, block quote, fn main, header a, cell 1, Embedded note | Reading container spike, resolved note, absent note, Second level heading, first bullet, nested bullet, ordered one, an open task, a done task, block quote, fn main, header a, cell 1, Embedded note |
| landmarks out of order | none | none | none | none | none | none |
| List peers | 0 | 0 | 2 | 2 | 1 | 1 |
| ListItem peers | 0 | 0 | 7 | 7 | 0 | 0 |
| HeadingLevel survives | **no** | **no** | **yes** | **yes** | **yes** | **yes** |
| hyperlink peers | 0 | 0 | 5 | 5 | 5 | 5 |
| links w/ HelpText | 0 | 0 | 2 | 2 | 2 | 2 |
| interactive children | 6 | 6 | 10 | 10 | 4 | 4 |
