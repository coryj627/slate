...
public sealed class A11yCorpusCensus
{
    ...
    [
        ...
        // --- Canvas (W6-1 0a, #745) ---
        new A11yEvent.CanvasMovedTo(Verbosity: CanvasVerbosity.Terse, KindLabel: "text", Title: "Research", OrdinalN: 2, TotalM: 5, Container: "Q3", ConnectionCount: 3, ColorName: "red", Marked: true),
        new A11yEvent.CanvasMovedTo(Verbosity: CanvasVerbosity.Standard, KindLabel: "text", Title: "Research", OrdinalN: 2, TotalM: 5, Container: "Q3", ConnectionCount: 3, ColorName: "red", Marked: true),
        new A11yEvent.CanvasMovedTo(Verbosity: CanvasVerbosity.Verbose, KindLabel: "text", Title: "Research", OrdinalN: 2, TotalM: 5, Container: "Q3", ConnectionCount: 3, ColorName: "red", Marked: true),
        new A11yEvent.CanvasMovedTo(Verbosity: CanvasVerbosity.Standard, KindLabel: "group", Title: "Q3", OrdinalN: 1, TotalM: 3, Container: null, ConnectionCount: 0, ColorName: null, Marked: false),
        new A11yEvent.CanvasMovedTo(Verbosity: CanvasVerbosity.Verbose, KindLabel: "file", Title: "Notes.md", OrdinalN: 1, TotalM: 1, Container: null, ConnectionCount: 1, ColorName: null, Marked: false),
        new A11yEvent.CanvasGroupEntered(Label: "Q3", Count: 4),
        new A11yEvent.CanvasGroupEntered(Label: "Solo", Count: 1),
        new A11yEvent.CanvasGroupLeft(Label: "Q3"),
        new A11yEvent.CanvasConnectionTraversed(Direction: CanvasEdgeDirection.Outgoing, KindLabel: "text", Title: "Ideas", Label: "supports"),
        new A11yEvent.CanvasConnectionTraversed(Direction: CanvasEdgeDirection.Incoming, KindLabel: "text", Title: "Research", Label: null),
        new A11yEvent.CanvasConnectionTraversed(Direction: CanvasEdgeDirection.Undirected, KindLabel: "group", Title: "Q3", Label: null),
        new A11yEvent.CanvasConnectionTraversed(Direction: CanvasEdgeDirection.Bidirectional, KindLabel: "link", Title: "example.com", Label: null),
        new A11yEvent.CanvasTracePathEnd(Titles: ["Research", "Ideas", "Draft"]),
        new A11yEvent.CanvasMoveRelative(Descs: [], Overlap: null),
        new A11yEvent.CanvasMoveRelative(Descs: [new CanvasRelativeDesc.Below(AnchorTitle: "Research")], Overlap: null),
        new A11yEvent.CanvasMoveRelative(Descs: [new CanvasRelativeDesc.Below(AnchorTitle: "Research"), new CanvasRelativeDesc.RightOf(AnchorTitle: "Ideas")], Overlap: CanvasOverlapTransition.Onset),
        new A11yEvent.CanvasMoveRelative(Descs: [new CanvasRelativeDesc.Above(AnchorTitle: "Ideas")], Overlap: CanvasOverlapTransition.Cleared),
        new A11yEvent.CanvasResizeGeometry(Preset: null, Width: 320, Height: 200, Overlap: null),
        new A11yEvent.CanvasResizeGeometry(Preset: CanvasResizePreset.DefaultSize, Width: 260, Height: 140, Overlap: null),
        new A11yEvent.CanvasResizeGeometry(Preset: CanvasResizePreset.FitToContent, Width: 260, Height: 88, Overlap: CanvasOverlapTransition.Onset),
        new A11yEvent.CanvasResizeClamped(),
        new A11yEvent.CanvasModeEntered(Mode: CanvasMode.Move, Object: new CanvasModeObject.Card(Title: "Research")),
        new A11yEvent.CanvasModeEntered(Mode: CanvasMode.Move, Object: new CanvasModeObject.Cards(Count: 3)),
        new A11yEvent.CanvasModeEntered(Mode: CanvasMode.Resize, Object: new CanvasModeObject.Card(Title: "Research")),
        new A11yEvent.CanvasModeEntered(Mode: CanvasMode.Connect, Object: new CanvasModeObject.Card(Title: "Research")),
        new A11yEvent.CanvasModeRejected(ActiveMode: CanvasMode.Move),
        new A11yEvent.CanvasModeCommitted(Verb: CanvasTransientVerb.Move, Object: new CanvasModeObject.Card(Title: "Research")),
        new A11yEvent.CanvasModeCommitted(Verb: CanvasTransientVerb.Move, Object: new CanvasModeObject.Cards(Count: 3)),
        new A11yEvent.CanvasModeCommitted(Verb: CanvasTransientVerb.Resize, Object: new CanvasModeObject.Card(Title: "Research")),
        new A11yEvent.CanvasModeEndedWithoutEffect(Mode: CanvasMode.Move),
        new A11yEvent.CanvasModeEndedWithoutEffect(Mode: CanvasMode.Resize),
        new A11yEvent.CanvasModeEndedWithoutEffect(Mode: CanvasMode.Connect),
        new A11yEvent.CanvasModeCancelled(Mode: CanvasMode.Move, Restoration: new CanvasModeRestoration.Unstated()),
        new A11yEvent.CanvasModeCancelled(Mode: CanvasMode.Move, Restoration: new CanvasModeRestoration.CardsReturned(Count: 1)),
        new A11yEvent.CanvasModeCancelled(Mode: CanvasMode.Move, Restoration: new CanvasModeRestoration.CardsReturned(Count: 3)),
        new A11yEvent.CanvasModeCancelled(Mode: CanvasMode.Resize, Restoration: new CanvasModeRestoration.Unstated()),
        new A11yEvent.CanvasModeCancelled(Mode: CanvasMode.Resize, Restoration: new CanvasModeRestoration.SizeRestored()),
        new A11yEvent.CanvasModeCancelled(Mode: CanvasMode.Connect, Restoration: new CanvasModeRestoration.Unstated()),
        new A11yEvent.CanvasModeCancelled(Mode: CanvasMode.Connect, Restoration: new CanvasModeRestoration.BackAt(Title: "Research")),
        new A11yEvent.CanvasCreated(KindLabel: "text", Title: "New idea", Relative: new CanvasRelativeDesc.Below(AnchorTitle: "Research")),
        new A11yEvent.CanvasCreated(KindLabel: "group", Title: "Q3", Relative: new CanvasRelativeDesc.RightOf(AnchorTitle: "Research")),
        new A11yEvent.CanvasCreated(KindLabel: "file", Title: "Notes.md", Relative: new CanvasRelativeDesc.Above(AnchorTitle: "Research")),
        new A11yEvent.CanvasCreated(KindLabel: "link", Title: "example.com", Relative: new CanvasRelativeDesc.LeftOf(AnchorTitle: "Research")),
        new A11yEvent.CanvasCreated(KindLabel: "text", Title: "Untitled", Relative: new CanvasRelativeDesc.AtOrigin()),
        new A11yEvent.CanvasFileCreated(Name: "Roadmap"),
        new A11yEvent.CanvasConnectedCardCreated(Relative: new CanvasRelativeDesc.Below(AnchorTitle: "Research"), OriginTitle: "Research"),
        new A11yEvent.CanvasConnected(FromTitle: "Research", ToTitle: "Ideas", Label: "supports"),
        new A11yEvent.CanvasConnected(FromTitle: "Research", ToTitle: "Ideas", Label: null),
        new A11yEvent.CanvasConnectionUpdated(Label: "supports"),
        new A11yEvent.CanvasConnectionUpdated(Label: null),
        new A11yEvent.CanvasMovedIntoGroup(Label: "Q3"),
        new A11yEvent.CanvasRemovedFromGroup(Label: "Q3"),
        new A11yEvent.CanvasColorSet(Title: "Research", ColorName: "red"),
        new A11yEvent.CanvasColorSet(Title: "Research", ColorName: null),
        new A11yEvent.CanvasRenamedGroup(Label: "Q3"),
        new A11yEvent.CanvasCardUpdated(Title: "Research"),
        new A11yEvent.CanvasCardRetargeted(Title: "Research", Path: "notes/research.md"),
        new A11yEvent.CanvasCardPlaced(Verb: CanvasPlaceVerb.Moved, Title: "Research", Relative: new CanvasRelativeDesc.Below(AnchorTitle: "Ideas")),
        new A11yEvent.CanvasCardPlaced(Verb: CanvasPlaceVerb.Duplicated, Title: "Research", Relative: new CanvasRelativeDesc.RightOf(AnchorTitle: "Research")),
        new A11yEvent.CanvasCardAligned(Title: "Research", TargetTitle: "Ideas"),
        new A11yEvent.CanvasConvertedToNote(Path: "notes/research.md"),
        new A11yEvent.CanvasDeleted(Target: new CanvasDeleteTarget.Card(KindLabel: "text", Title: "Research"), Verbosity: CanvasVerbosity.Standard, UndoChord: "⌘Z"),
        new A11yEvent.CanvasDeleted(Target: new CanvasDeleteTarget.Card(KindLabel: "text", Title: "Research"), Verbosity: CanvasVerbosity.Terse, UndoChord: "⌘Z"),
        new A11yEvent.CanvasDeleted(Target: new CanvasDeleteTarget.Group(Label: "Q3"), Verbosity: CanvasVerbosity.Standard, UndoChord: "⌘Z"),
        new A11yEvent.CanvasDeleted(Target: new CanvasDeleteTarget.Cards(Count: 3), Verbosity: CanvasVerbosity.Standard, UndoChord: "Ctrl+Z"),
        new A11yEvent.CanvasDeleted(Target: new CanvasDeleteTarget.Cards(Count: 1), Verbosity: CanvasVerbosity.Verbose, UndoChord: "⌘Z"),
        new A11yEvent.CanvasDeleted(Target: new CanvasDeleteTarget.Connection(Direction: CanvasEdgeDirection.Outgoing, OtherTitle: "Ideas", Label: "supports"), Verbosity: CanvasVerbosity.Standard, UndoChord: "⌘Z"),
        new A11yEvent.CanvasDeleted(Target: new CanvasDeleteTarget.Connection(Direction: CanvasEdgeDirection.Incoming, OtherTitle: "Research", Label: null), Verbosity: CanvasVerbosity.Terse, UndoChord: "⌘Z"),
        new A11yEvent.CanvasDeleted(Target: new CanvasDeleteTarget.Connection(Direction: CanvasEdgeDirection.Undirected, OtherTitle: "Q3", Label: null), Verbosity: CanvasVerbosity.Standard, UndoChord: "⌘Z"),
        new A11yEvent.CanvasBulkMoved(Count: 3, Relative: new CanvasRelativeDesc.Below(AnchorTitle: "Research")),
        new A11yEvent.CanvasBulkColorSet(Count: 3, ColorName: "cyan"),
        new A11yEvent.CanvasBulkColorSet(Count: 1, ColorName: null),
        new A11yEvent.CanvasGrouped(Count: 3, Label: "Q3"),
        new A11yEvent.CanvasBulkDuplicated(Count: 2),
        new A11yEvent.CanvasMarkToggled(Marked: true, Title: "Research", Count: 2),
        new A11yEvent.CanvasMarkToggled(Marked: false, Title: "Research", Count: 1),
        new A11yEvent.CanvasMarksCleared(Count: 0),
        new A11yEvent.CanvasMarksCleared(Count: 3),
        new A11yEvent.CanvasFilterCount(Matched: 3),
        new A11yEvent.CanvasFilterCount(Matched: 1),
        new A11yEvent.CanvasFilterCleared(Total: 40),
        new A11yEvent.CanvasFilterCleared(Total: 1),
        new A11yEvent.CanvasZoom(Context: null, Percent: 100),
        new A11yEvent.CanvasZoom(Context: CanvasZoomContext.FitCanvas, Percent: 80),
        new A11yEvent.CanvasZoom(Context: CanvasZoomContext.ZoomedToSelection, Percent: 150),
        new A11yEvent.CanvasFollowSelectionToggled(Following: true),
        new A11yEvent.CanvasFollowSelectionToggled(Following: false),
        new A11yEvent.CanvasSurfaceShown(Surface: CanvasSurfaceKind.Outline),
        new A11yEvent.CanvasSurfaceShown(Surface: CanvasSurfaceKind.Table),
        new A11yEvent.CanvasSurfaceShown(Surface: CanvasSurfaceKind.Visual),
        new A11yEvent.CanvasHistoryApplied(Verb: CanvasHistoryVerb.Undo, Name: "move \"Research\""),
        new A11yEvent.CanvasHistoryApplied(Verb: CanvasHistoryVerb.Redo, Name: "move \"Research\""),
        new A11yEvent.CanvasUndoMenuTitle(Verb: CanvasHistoryVerb.Undo, Name: "delete \"My Card\""),
        new A11yEvent.CanvasUndoMenuTitle(Verb: CanvasHistoryVerb.Redo, Name: ""),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NothingSelected()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoMarks()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NotAGroup()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NotATextCard()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NotAFileCard()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoGroups()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoNotesInVault()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoMediaInVault()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoFilesToPointAt()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.OnlyTextCardsConvert()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoConnections()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.PickOutsideMovingSet()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.PickDifferentTarget()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoChanges()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NotReadable()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.Empty()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.EndOfCanvas()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.StartOfCanvas()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.AtCanvasLevel()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoCardsMatchFilter()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NothingToUndo()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NothingToRedo()),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.GroupIsEmpty(Label: "Q3")),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoOutgoingPath(Title: "Research")),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NotInAGroup(Title: "Research")),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoConnection(Forward: true, Ordinal: null)),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoConnection(Forward: true, Ordinal: 2)),
        new A11yEvent.CanvasStatus(Note: new CanvasStatusNote.NoConnection(Forward: false, Ordinal: null)),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.ModeBusy()),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.UndoBlocked()),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.RedoBlocked()),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.LinkOpenFailed()),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.AlignWouldOverlap()),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.NotAUrl()),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.CardTextUnreadable()),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.NotePathMustEndInMd()),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.NoFreeSpaceInGroup(Label: "Q3")),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.NotePathExists(Path: "notes/research.md", OnDisk: false)),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.NotePathExists(Path: "notes/research.md", OnDisk: true)),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.NoteReadFailed(Message: "The card text is unavailable.")),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.NoteCreateFailed(Path: "notes/research.md", Message: "io error")),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.NoteRetargetFailed(Path: "notes/research.md", Message: "io error")),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.HeadingNotFound(Heading: "Roadmap", Filename: "notes.md")),
        new A11yEvent.CanvasBlocked(Reason: new CanvasBlockedReason.ReopenFailed(Message: "The file moved.")),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.NewCard, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.NewGroup, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.NewCanvas, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.MoveIntoGroup, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.Placement, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.Align, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.Create, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.RemoveFromGroup, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.Duplicate, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.CreateConnectedCard, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.CanvasAction, Detail: "the file is read-only"),
        new A11yEvent.CanvasActionFailed(Action: CanvasFailedAction.WhereAmI, Detail: "the file is read-only"),
        new A11yEvent.CanvasSaveConflict(),
        new A11yEvent.CanvasFileNotFound(Target: "media/diagram.png"),
        new A11yEvent.CanvasOpened(Title: "Notes.md", Target: CanvasOpenTarget.DefaultApp),
        new A11yEvent.CanvasOpened(Title: "example.com", Target: CanvasOpenTarget.Browser),
        new A11yEvent.CanvasMutationRefused(Reason: CanvasMutationRefusal.Opening),
        new A11yEvent.CanvasMutationRefused(Reason: CanvasMutationRefusal.Reopening),
        new A11yEvent.CanvasMutationRefused(Reason: CanvasMutationRefusal.RetargetFailed),
        new A11yEvent.CanvasMutationRefused(Reason: CanvasMutationRefusal.Unavailable),
        new A11yEvent.CanvasMutationRefused(Reason: CanvasMutationRefusal.ReadOnly),
        new A11yEvent.CanvasMutationRefused(Reason: CanvasMutationRefusal.CardEditorUnavailable),
        new A11yEvent.CanvasLoadedDegraded(Skipped: 3),
        new A11yEvent.CanvasLoadedDegraded(Skipped: 1),
        new A11yEvent.CanvasEmptyOnboarding(NewCardChord: "Option Command N", PaletteChord: "Command Shift P"),
        new A11yEvent.CanvasWhereAmI(KindLabel: "text", Title: "Research", GroupPath: ["Quarter", "Q3"], OrdinalN: 2, TotalM: 5, ConnectionCount: 3, InCount: 1, OutCount: 2, ColorName: "red", Marked: true, Mode: CanvasMode.Move, Filter: new CanvasFilterState.Active(Matched: 3, Total: 40)),
        new A11yEvent.CanvasWhereAmI(KindLabel: "text", Title: "Loose", GroupPath: [], OrdinalN: 1, TotalM: 1, ConnectionCount: 1, InCount: 1, OutCount: 0, ColorName: null, Marked: false, Mode: null, Filter: new CanvasFilterState.Inactive()),
    ];
